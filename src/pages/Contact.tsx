        ...
        <div ref={ref} className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 mt-8">
          ...
          >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label htmlFor="contact-name" className="block text-xs tracking-[0.2em] uppercase font-body font-medium text-cream-100/50 mb-2">
                    {t('contact.form.name')}
                  </label>
                  <input
                    id="contact-name"
                ...
                <div>
                  <label htmlFor="contact-email" className="block text-xs tracking-[0.2em] uppercase font-body font-medium text-cream-100/50 mb-2">
                ...
                <div>
                  <label htmlFor="contact-message" className="block text-xs tracking-[0.2em] uppercase font-body font-medium text-cream-100/50 mb-2">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <InfoBox
                ...
                lines={[t('footer.phoneNumber')]}
                href={`tel:${t('footer.phoneNumber')}`}
              />
              <InfoBox
                icon="mail"
                title={t('contact.info.email')}
                lines={[t('footer.emailAddress')]}
                href={`mailto:${t('footer.emailAddress')}`}
              />
              <InfoBox
                icon="clock"
                title={t('contact.info.hours')}
                lines={t('contact.info.hoursLines', { returnObjects: true }) as string[]}
              />
            </div>
            ...
            <div className="border border-gold-400/20 overflow-hidden">
              <div className="aspect-[16/9] bg-gradient-to-br from-bronze-700/50 to-charcoal-800/80 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-cream-100/40 text-xs font-body mt-1">{t('footer.addressLine1')}, {t('footer.addressLine2')}</p>
                </div>
              </div>
            </div>
...
function InfoBox({ icon, title, lines, href }: InfoBoxProps) {
  return (
